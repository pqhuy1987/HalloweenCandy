...
Hero::Hero(cocos2d::Layer *layer)
{
    ...
    auto size=M_hero->getContentSize();
...
void Hero::move()
{
    if ((M_hero->getPositionX()-(M_hero->getContentSize().width)/2)<origin.x)
    {
        hero_atside=1;
    }
    else if ((M_hero->getPositionX()+(M_hero->getContentSize().width)/2)>(origin.x+visibleSize.width))
    {
        hero_atside=2;
    }
    else if ((M_hero->getPositionY()-(M_hero->getContentSize().height)/2)<origin.y)
    {
        hero_atside=3;
    }
    else if((M_hero->getPositionY()+(M_hero->getContentSize().height)/2)<(origin.y+visibleSize.height))
    {
        hero_atside=4;
    }
    else
