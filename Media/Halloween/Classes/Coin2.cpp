...
void Coin2::spawnCoin2(cocos2d::Layer * layer)
{
    ...
    auto posi_x=(ran*(visibleSize.width/2-coin->getContentSize().width* SCALE_TO_DEVICE))+origin.x+coin->getContentSize().width* SCALE_TO_DEVICE/2;
...
void Coin2::spawnCoin2_2(cocos2d::Layer * layer)
{
    ...
    //coin->setScale(1.5, 1.5);
    auto ran=CCRANDOM_0_1();
    auto posi_x=(ran*(visibleSize.width/2-coin->getContentSize().width* SCALE_TO_DEVICE))+origin.x+visibleSize.width/2+coin->getContentSize().width* SCALE_TO_DEVICE/2;
    auto posi_y=origin.y+visibleSize.height;
