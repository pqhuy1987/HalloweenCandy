...
bool GuideScene::init()
{
    ...
    menuItem->setScale(SCALE_TO_DEVICE);
...
void GuideScene::Guide_move()
{
    ...
    auto gameTitle= Label::createWithTTF("music/sfx credit to freesfx.co.uk", "Lucky7.otf", visibleSize.width * SCORE_FONT * 0.2);
